(() => {
    ...
    function activeMenu() {
        ...
        a.forEach((el => {
            if (el.getAttribute("href") == window.location.pathname.substring(1)) el.classList.add("active");
            el.classList.remove("active");
            if (el.getAttribute("href") == window.location.pathname.substring(1) + window.location.hash) el.classList.add("active");
        }));
    }
    window["FLS"] = true;
    isWebp();
